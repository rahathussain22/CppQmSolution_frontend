...
import { getWeldSummaryNDTTrackingReport } from "@/api/reports";

export default function IRW002() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await getWeldSummaryNDTTrackingReport({
    ...
    <div className="p-4 space-y-4">
      <div className="flex items-center justify-between">
        <h4 className="text-3xl font-bold">
          Weld Summary & NDT Tracking System (IR-CSSP-W-002)
        </h4>
      </div>
