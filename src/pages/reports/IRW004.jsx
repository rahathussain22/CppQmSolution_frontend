...
import { getWeldVisualInspectionReport } from "@/api/reports";

export default function IRW004() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success(result?.message || "Weld Visual Inspection Report generated.");
    } catch (error) {
    ...
    <div className="p-4 space-y-4">
      <div className="flex items-center justify-between">
        <h4 className="text-3xl font-bold">
          Weld Visual Inspection (IR-CSSP-W-004)
        </h4>
      </div>
