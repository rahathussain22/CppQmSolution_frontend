...
import { getNDTSummaryReport } from "@/api/reports";

export default function IRW005() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success(result?.message || "NDT Summary Report generated.");
    } catch (error) {
